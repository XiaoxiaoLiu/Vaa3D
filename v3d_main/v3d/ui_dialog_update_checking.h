...
public:
    ...
    {
        checking_for_updates_dialog->setWindowTitle(QApplication::translate("checking_for_updates_dialog", "Dialog", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("checking_for_updates_dialog", "V3D is checking for updates", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
