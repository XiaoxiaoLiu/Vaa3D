...
public:
    ...
    {
        AngleWidget->setWindowTitle(QApplication::translate("AngleWidget", "Form", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("AngleWidget", "RotX ", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        spinBox->setToolTip(QApplication::translate("AngleWidget", "enter rotation angle in degrees", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        spinBox->setSuffix(QApplication::translate("AngleWidget", "\302\260", 0, QApplication::UnicodeUTF8));
        spinBox->setPrefix(QString());
#ifndef QT_NO_TOOLTIP
        dial->setToolTip(QApplication::translate("AngleWidget", "drag dial with mouse to rotate", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
