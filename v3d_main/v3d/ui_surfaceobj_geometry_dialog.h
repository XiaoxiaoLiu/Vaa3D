...
public:
    ...
    {
        SurfaceObjGeometryDialog->setWindowTitle(QApplication::translate("SurfaceObjGeometryDialog", "Basic Geometry of Surface Object", 0, QApplication::UnicodeUTF8));
...
"current absolute coordinates.", 0, QApplication::UnicodeUTF8));
        label_7->setText(QApplication::translate("SurfaceObjGeometryDialog", "axis", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("SurfaceObjGeometryDialog", "X", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("SurfaceObjGeometryDialog", "Y", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("SurfaceObjGeometryDialog", "Z", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("SurfaceObjGeometryDialog", "shift", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("SurfaceObjGeometryDialog", "scaling * 1000", 0, QApplication::UnicodeUTF8));
        label_8->setText(QApplication::translate("SurfaceObjGeometryDialog", "mirror", 0, QApplication::UnicodeUTF8));
        checkBox_flip_x->setText(QApplication::translate("SurfaceObjGeometryDialog", "flip X", 0, QApplication::UnicodeUTF8));
        checkBox_flip_y->setText(QApplication::translate("SurfaceObjGeometryDialog", "flip Y", 0, QApplication::UnicodeUTF8));
        checkBox_flip_z->setText(QApplication::translate("SurfaceObjGeometryDialog", "flip Z", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("SurfaceObjGeometryDialog", "rotation \n"
"(around the axis)", 0, QApplication::UnicodeUTF8));
        checkBox_enable_rotation->setText(QApplication::translate("SurfaceObjGeometryDialog", "use rotation", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("SurfaceObjGeometryDialog", "G-scaling * 1000", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("SurfaceObjGeometryDialog", "radius scaling * 1000", 0, QApplication::UnicodeUTF8));
        pushButton_undo_last->setText(QApplication::translate("SurfaceObjGeometryDialog", "Undo/redo last change", 0, QApplication::UnicodeUTF8));
        pushButton_reset->setText(QApplication::translate("SurfaceObjGeometryDialog", "Reset", 0, QApplication::UnicodeUTF8));
        pushButton_cancel->setText(QApplication::translate("SurfaceObjGeometryDialog", "Cancel", 0, QApplication::UnicodeUTF8));
        pushButton_ok->setText(QApplication::translate("SurfaceObjGeometryDialog", "OK", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
