...
public:
    ...
    void setupUi(QDialog *Dialog_v3d_preference)
    {
        ...
        widget = new QWidget(V3D_setting_mainwindow);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(12, 30, 501, 211));
        verticalLayout_3 = new QVBoxLayout(widget);
        verticalLayout_3->setObjectName(QString::fromUtf8("verticalLayout_3"));
        verticalLayout_3->setContentsMargins(0, 0, 0, 0);
        checkBox_yaxis_up = new QCheckBox(widget);
        checkBox_yaxis_up->setObjectName(QString::fromUtf8("checkBox_yaxis_up"));

        verticalLayout_3->addWidget(checkBox_yaxis_up);

        checkBox_autoConvert2_8bit = new QCheckBox(widget);
        ...
        spinBox_defaultRightShiftBits = new QSpinBox(widget);
        ...
        checkBox_autoRescale16bitDisplay = new QCheckBox(widget);
        ...
        spinBox_lookGlassSize = new QSpinBox(widget);
        ...
        spinBox_markerSize = new QSpinBox(widget);
        ...
        checkBox_libTiff_Mylib = new QCheckBox(widget);
        ...
        layoutWidget1 = new QWidget(V3D_setting_3dviewer);
        layoutWidget1->setObjectName(QString::fromUtf8("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(30, 10, 359, 126));
        verticalLayout = new QVBoxLayout(layoutWidget1);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        checkBox_autoOpenImg3DViewer = new QCheckBox(layoutWidget1);
        ...
        checkBox_autoDispXYZAxes = new QCheckBox(layoutWidget1);
        ...
        checkBox_autoDispBoundingBox = new QCheckBox(layoutWidget1);
        ...
        spinBox_markerAmplifyFactor = new QSpinBox(layoutWidget1);
        ...
        checkBox_autoSWCLineMode = new QCheckBox(layoutWidget1);
        ...
        layoutWidget2->setGeometry(QRect(10, 30, 431, 87));
        gridLayout1 = new QGridLayout(layoutWidget2);
        gridLayout1->setObjectName(QString::fromUtf8("gridLayout1"));
        gridLayout1->setContentsMargins(0, 0, 0, 0);
        checkBox_3dcurve_inertia = new QCheckBox(layoutWidget2);
        ...
        checkBox_3dcurve_autoconnecttips = new QCheckBox(layoutWidget2);
        ...
        checkBox_3dcurve_autodeform = new QCheckBox(layoutWidget2);
        ...
        checkBox_3dcurve_autowidth = new QCheckBox(layoutWidget2);
        ...
        checkBox_3dcurve_width_from_xyonly = new QCheckBox(layoutWidget2);
        ...
        layoutWidget3->setGeometry(QRect(20, 20, 487, 122));
        ...
        spinBox_iChannel_for_plugin = new QSpinBox(layoutWidget3);
        ...
        checkBox_b_plugin_dispResInNewWindow = new QCheckBox(layoutWidget3);
        ...
        checkBox_b_plugin_dispParameterDialog = new QCheckBox(layoutWidget3);
        ...
        checkBox_b_plugin_outputImgRescale = new QCheckBox(layoutWidget3);
        ...
        checkBox_b_plugin_outputImgConvert2UINT8 = new QCheckBox(layoutWidget3);
