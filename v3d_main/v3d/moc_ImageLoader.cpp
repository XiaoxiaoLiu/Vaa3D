...
int ImageLoader::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: progressComplete((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: progressAborted((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: progressMessageChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
