...
const QMetaObject jfrc::VolumeTexture::staticMetaObject = {
    { &NaSharedDataModel<PrivateVolumeTexture>::staticMetaObject, qt_meta_stringdata_jfrc__VolumeTexture,
      qt_meta_data_jfrc__VolumeTexture, 0 }
};
...
int jfrc::VolumeTexture::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: visibilityTextureChanged(); break;
        case 1: colorMapTextureChanged(); break;
        case 2: labelTextureChanged(); break;
        case 3: signalTextureChanged(); break;
        case 4: signalMetadataChanged(); break;
        case 5: benchmarkTimerResetRequested(); break;
        case 6: benchmarkTimerPrintRequested((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 7: volumeLoadSequenceCompleted(); break;
        case 8: mpegQueueRequested((*reinterpret_cast< QUrl(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 9: mpegLoadSequenceRequested(); break;
        case 10: loadNextVolumeRequested(); break;
        case 11: { bool _r = updateVolume();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 12: updateNeuronVisibilityTexture(); break;
        case 13: { bool _r = updateColorMapTexture();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 14: { bool _r = loadLabelPbdFile();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 15: setLabelPbdFileUrl((*reinterpret_cast< QUrl(*)>(_a[1]))); break;
        case 16: { bool _r = loadSignalRawFile((*reinterpret_cast< QUrl(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 17: { bool _r = loadReferenceRawFile((*reinterpret_cast< QUrl(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 18: loadStagedVolumes(); break;
        case 19: { bool _r = queueSeparationFolder((*reinterpret_cast< QUrl(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 20: queueVolumeData(); break;
        default: ;
        }
        _id -= 21;
    }
