...
public:
    ...
    {
        CutPlannerDialog->setWindowTitle(QApplication::translate("CutPlannerDialog", "microCT Trim Planner", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("CutPlannerDialog", "Voxel size:", 0, QApplication::UnicodeUTF8));
        micrometersBox->setSuffix(QApplication::translate("CutPlannerDialog", "\302\265m", 0, QApplication::UnicodeUTF8));
        labelBrainCompartmentsButton->setText(QApplication::translate("CutPlannerDialog", "Label Neuropil Compartments", 0, QApplication::UnicodeUTF8));
        savePlanButton->setText(QApplication::translate("CutPlannerDialog", "Save File...", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
