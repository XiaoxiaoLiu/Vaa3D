...
public:
    ...
    {
        curve_trace_dialog->setWindowTitle(QApplication::translate("curve_trace_dialog", "Curve tracing parameters", 0, QApplication::UnicodeUTF8));
        label_start_landmark->setText(QApplication::translate("curve_trace_dialog", "start landmark ID", 0, QApplication::UnicodeUTF8));
        label_end_landmark->setText(QApplication::translate("curve_trace_dialog", "end landmark ID", 0, QApplication::UnicodeUTF8));
        label_12->setText(QApplication::translate("curve_trace_dialog", "data channel", 0, QApplication::UnicodeUTF8));
        checkBox_b_curve->setText(QApplication::translate("curve_trace_dialog", "Hybrid curve parameters ", 0, QApplication::UnicodeUTF8));
        label_15->setText(QApplication::translate("curve_trace_dialog", "resolution step", 0, QApplication::UnicodeUTF8));
        checkBox_b_6connect->setText(QApplication::translate("curve_trace_dialog", "6-connect", 0, QApplication::UnicodeUTF8));
        checkBox_b_fullimage->setText(QApplication::translate("curve_trace_dialog", "full image", 0, QApplication::UnicodeUTF8));
        label_20->setText(QApplication::translate("curve_trace_dialog", "final path sub-sampling step", 0, QApplication::UnicodeUTF8));
        label_17->setText(QApplication::translate("curve_trace_dialog", "final radius smoothing step", 0, QApplication::UnicodeUTF8));
        label_18->setText(QApplication::translate("curve_trace_dialog", "Deformable model parameters", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("curve_trace_dialog", "# optimization loops", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("curve_trace_dialog", "# control points", 0, QApplication::UnicodeUTF8));
        checkBox_adaptiveCtrlPoints->setText(QApplication::translate("curve_trace_dialog", "adaptive", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("curve_trace_dialog", "length force weight", 0, QApplication::UnicodeUTF8));
        label_7->setText(QApplication::translate("curve_trace_dialog", "smoothness force weight", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("curve_trace_dialog", "prior force weight", 0, QApplication::UnicodeUTF8));
        checkBox_estimateRadii->setText(QApplication::translate("curve_trace_dialog", "Estimate radii", 0, QApplication::UnicodeUTF8));
        checkBox_postMergeClosebyBranches->setText(QApplication::translate("curve_trace_dialog", "Post merge closeby branches", 0, QApplication::UnicodeUTF8));
        cancelButton->setText(QApplication::translate("curve_trace_dialog", "Cancel tracing", 0, QApplication::UnicodeUTF8));
        okButton->setText(QApplication::translate("curve_trace_dialog", "OK", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
