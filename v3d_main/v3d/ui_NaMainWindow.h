...
"background-color: rgb(0, 0, 0);"));
    ...
    {
        NaMainWindow->setWindowTitle(QApplication::translate("NaMainWindow", "(No image loaded) - Vaa3D NeuronAnnotator", 0, QApplication::UnicodeUTF8));
        actionOpen->setText(QApplication::translate("NaMainWindow", "Open MultiColor Stack Folder...", 0, QApplication::UnicodeUTF8));
        ...
        actionV3DDefault->setText(QApplication::translate("NaMainWindow", "Vaa3D default", 0, QApplication::UnicodeUTF8));
        ...
        actionUndo->setText(QApplication::translate("NaMainWindow", "Undo", 0, QApplication::UnicodeUTF8));
        actionRedo->setText(QApplication::translate("NaMainWindow", "Redo", 0, QApplication::UnicodeUTF8));
        actionSelect_All->setText(QApplication::translate("NaMainWindow", "Select All", 0, QApplication::UnicodeUTF8));
        actionSelect_None->setText(QApplication::translate("NaMainWindow", "Select None", 0, QApplication::UnicodeUTF8));
        actionInvert_Selection->setText(QApplication::translate("NaMainWindow", "Invert Selection", 0, QApplication::UnicodeUTF8));
        action3D_Volume->setText(QApplication::translate("NaMainWindow", "3D Volume...", 0, QApplication::UnicodeUTF8));
        action2D_MIP->setText(QApplication::translate("NaMainWindow", "2D MIP...", 0, QApplication::UnicodeUTF8));
        actionScreenShot->setText(QApplication::translate("NaMainWindow", "ScreenShot...", 0, QApplication::UnicodeUTF8));
        actionFoo->setText(QApplication::translate("NaMainWindow", "Foo", 0, QApplication::UnicodeUTF8));
        actionClear_Hide_All->setText(QApplication::translate("NaMainWindow", "Hide everything", 0, QApplication::UnicodeUTF8));
        actionShow_all_neurons_in_empty_space->setText(QApplication::translate("NaMainWindow", "Show all neurons in empty space", 0, QApplication::UnicodeUTF8));
        actionMono_Off->setText(QApplication::translate("NaMainWindow", "Mono/Off", 0, QApplication::UnicodeUTF8));
        actionLeft_eye_view->setText(QApplication::translate("NaMainWindow", "Left Eye View", 0, QApplication::UnicodeUTF8));
        actionRight_eye_view->setText(QApplication::translate("NaMainWindow", "Right Eye View", 0, QApplication::UnicodeUTF8));
        actionAnaglyph_Red_Cyan->setText(QApplication::translate("NaMainWindow", "Anaglyph Red/Cyan", 0, QApplication::UnicodeUTF8));
        actionAnaglyph_Green_Magenta->setText(QApplication::translate("NaMainWindow", "Anaglyph Green/Magenta", 0, QApplication::UnicodeUTF8));
        actionRow_Interleaved_Zalman->setText(QApplication::translate("NaMainWindow", "Row Interleaved (Zalman)", 0, QApplication::UnicodeUTF8));
        actionQuadro_120_Hz->setText(QApplication::translate("NaMainWindow", "Quadro (120 Hz)", 0, QApplication::UnicodeUTF8));
        actionSwap_Eyes->setText(QApplication::translate("NaMainWindow", "Swap Eyes", 0, QApplication::UnicodeUTF8));
        actionShow_Axes->setText(QApplication::translate("NaMainWindow", "Show Axes", 0, QApplication::UnicodeUTF8));
        action3D_alpha_blending->setText(QApplication::translate("NaMainWindow", "Use 3D alpha blending", 0, QApplication::UnicodeUTF8));
        actionAnimate_3D_nutation->setText(QApplication::translate("NaMainWindow", "Animate 3D nutation", 0, QApplication::UnicodeUTF8));
        actionDynamic_range->setText(QApplication::translate("NaMainWindow", "Data colors...", 0, QApplication::UnicodeUTF8));
        actionShow_Brain_Compartments->setText(QApplication::translate("NaMainWindow", "Show Brain Compartments", 0, QApplication::UnicodeUTF8));
        actionOpen_Single_Movie_Stack->setText(QApplication::translate("NaMainWindow", "Open single stack...", 0, QApplication::UnicodeUTF8));
        actionCurrent_MIP->setText(QApplication::translate("NaMainWindow", "Current MIP", 0, QApplication::UnicodeUTF8));
        actionChecker_Interleaved_3DTV->setText(QApplication::translate("NaMainWindow", "Checker Interleaved (3DTV)", 0, QApplication::UnicodeUTF8));
        actionFull_Screen->setText(QApplication::translate("NaMainWindow", "Full Screen", 0, QApplication::UnicodeUTF8));
        actionFull_Screen->setShortcut(QApplication::translate("NaMainWindow", "F", 0, QApplication::UnicodeUTF8));
        actionColumn_Interleaved->setText(QApplication::translate("NaMainWindow", "Column Interleaved", 0, QApplication::UnicodeUTF8));
        actionOpen_Reference_Channel->setText(QApplication::translate("NaMainWindow", "Open reference channel...", 0, QApplication::UnicodeUTF8));
        actionOpen_Neuron_Mask->setText(QApplication::translate("NaMainWindow", "Open neuron mask...", 0, QApplication::UnicodeUTF8));
        actionLoad_movie_as_texture->setText(QApplication::translate("NaMainWindow", "Load movie as texture...", 0, QApplication::UnicodeUTF8));
        actionLoad_fast_separation_result->setText(QApplication::translate("NaMainWindow", "Open fast loading folder...", 0, QApplication::UnicodeUTF8));
        actionX_Rotation_Movie->setText(QApplication::translate("NaMainWindow", "X Rotation Movie...", 0, QApplication::UnicodeUTF8));
        actionMeasure_Frame_Rate->setText(QApplication::translate("NaMainWindow", "Measure Frame Rate", 0, QApplication::UnicodeUTF8));
        actionOpen_Octree_Volume->setText(QApplication::translate("NaMainWindow", "Open Octree Volume...", 0, QApplication::UnicodeUTF8));
        actionOpen_microCT_Cut_Planner->setText(QApplication::translate("NaMainWindow", "Open microCT Trim Planner", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        actionOpen_microCT_Cut_Planner->setToolTip(QApplication::translate("NaMainWindow", "Open microCT cut planning tool", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        actionAppend_key_frame_at_current_view->setText(QApplication::translate("NaMainWindow", "Add new key frame here", 0, QApplication::UnicodeUTF8));
        actionPlay_movie->setText(QApplication::translate("NaMainWindow", "Play movie", 0, QApplication::UnicodeUTF8));
        actionClear_movie->setText(QApplication::translate("NaMainWindow", "Clear movie", 0, QApplication::UnicodeUTF8));
        actionSave_movie_frames->setText(QApplication::translate("NaMainWindow", "Save movie frames", 0, QApplication::UnicodeUTF8));
        action1280x720->setText(QApplication::translate("NaMainWindow", "1280x720", 0, QApplication::UnicodeUTF8));
        actionAdd_landmark_at_cursor->setText(QApplication::translate("NaMainWindow", "Add landmark at cursor", 0, QApplication::UnicodeUTF8));
        actionClear_landmarks->setText(QApplication::translate("NaMainWindow", "Clear landmarks", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
"drag to pan\n"
"double-click to recenter", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        progressLabelMip->setText(QApplication::translate("NaMainWindow", "Updating MIP viewer...", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
"double-click to recenter", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        progressLabelZ->setText(QApplication::translate("NaMainWindow", "Updating Z stack view...", 0, QApplication::UnicodeUTF8));
        progressLabel3d->setText(QApplication::translate("NaMainWindow", "Updating 3D view...", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        v3dr_glwidget->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("NaMainWindow", "Loading data...", 0, QApplication::UnicodeUTF8));
        ...
        HDR_groupBox->setTitle(QApplication::translate("NaMainWindow", "Dynamic Range (HDR) Tool", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
"intensity range in the yellow search box.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        HDR_checkBox->setText(QApplication::translate("NaMainWindow", "Adjust dynamic range", 0, QApplication::UnicodeUTF8));
        HDRRed_pushButton->setText(QApplication::translate("NaMainWindow", "1", 0, QApplication::UnicodeUTF8));
        HDRGreen_pushButton->setText(QApplication::translate("NaMainWindow", "2", 0, QApplication::UnicodeUTF8));
        HDRBlue_pushButton->setText(QApplication::translate("NaMainWindow", "3", 0, QApplication::UnicodeUTF8));
        HDRNc82_pushButton->setText(QApplication::translate("NaMainWindow", "nc82", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        BoxSize_label->setToolTip(QApplication::translate("NaMainWindow", "Change the size of the interactive HDR region box.\n"
"You can also resize the box by Ctrl + left mouse click.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
"You can also resize the box by Ctrl + left mouse click.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ZSlice_groupBox->setTitle(QApplication::translate("NaMainWindow", "Z Slice", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        controlTabWidget->setToolTip(QApplication::translate("NaMainWindow", "Adjust 3D viewer object orientation", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        tabRotation->setToolTip(QApplication::translate("NaMainWindow", "Shift-drag in 3D viewer to rotate with the mouse.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        rotXWidget->setToolTip(QApplication::translate("NaMainWindow", "Rotate about the object X axis", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        rotXWidget->setProperty("textLabel", QVariant(QApplication::translate("NaMainWindow", "RotX", 0, QApplication::UnicodeUTF8)));
#ifndef QT_NO_TOOLTIP
        rotZWidget->setToolTip(QApplication::translate("NaMainWindow", "Rotate about the object Z axis", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        rotZWidget->setProperty("textLabel", QVariant(QApplication::translate("NaMainWindow", "RotZ", 0, QApplication::UnicodeUTF8)));
#ifndef QT_NO_TOOLTIP
        rotYWidget->setToolTip(QApplication::translate("NaMainWindow", "Rotate about the object Y axis", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        rotYWidget->setProperty("textLabel", QVariant(QApplication::translate("NaMainWindow", "RotY", 0, QApplication::UnicodeUTF8)));
#ifndef QT_NO_TOOLTIP
        rotationResetButton->setToolTip(QApplication::translate("NaMainWindow", "Restore original orientation to match MIP and Z-slice views", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        rotationResetButton->setText(QApplication::translate("NaMainWindow", "Reset Rotation", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        nutateButton->setToolTip(QApplication::translate("NaMainWindow", "Gently rotate the view to enhance the 3D effect.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        nutateButton->setText(QApplication::translate("NaMainWindow", "Nutate", 0, QApplication::UnicodeUTF8));
        controlTabWidget->setTabText(controlTabWidget->indexOf(tabRotation), QApplication::translate("NaMainWindow", "Rotation", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        tabVolumeCut->setToolTip(QString());
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        XCutCB->setToolTip(QApplication::translate("NaMainWindow", "checked to lock cut volume", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        XCutCB->setText(QApplication::translate("NaMainWindow", "XCut", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        YCutCB->setToolTip(QApplication::translate("NaMainWindow", "checked to lock cut volume", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        YCutCB->setText(QApplication::translate("NaMainWindow", "YCut", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        ZCutCB->setToolTip(QApplication::translate("NaMainWindow", "checked to lock cut volume", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ZCutCB->setText(QApplication::translate("NaMainWindow", "ZCut", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("NaMainWindow", "Front Slab", 0, QApplication::UnicodeUTF8));
        freezeFrontBackButton->setText(QApplication::translate("NaMainWindow", "Clip", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        slabThicknessSlider->setToolTip(QApplication::translate("NaMainWindow", "Adjust slab thickness", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        slabPositionSlider->setToolTip(QApplication::translate("NaMainWindow", "Adjust slab position", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        defineClipPlaneButton->setText(QApplication::translate("NaMainWindow", "Custom...", 0, QApplication::UnicodeUTF8));
        customCutButton->setText(QApplication::translate("NaMainWindow", "Clip", 0, QApplication::UnicodeUTF8));
        controlTabWidget->setTabText(controlTabWidget->indexOf(tabVolumeCut), QApplication::translate("NaMainWindow", "Volume Cut", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("NaMainWindow", "Z Thickness", 0, QApplication::UnicodeUTF8));
        compartmentSelectGroupBox->setTitle(QApplication::translate("NaMainWindow", "Compartment Map", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_3->setTitle(QApplication::translate("NaMainWindow", "View", 0, QApplication::UnicodeUTF8));
        resetViewButton->setText(QApplication::translate("NaMainWindow", "Reset View", 0, QApplication::UnicodeUTF8));
        groupBox_2->setTitle(QApplication::translate("NaMainWindow", "Color and Shading", 0, QApplication::UnicodeUTF8));
        redToggleButton->setText(QApplication::translate("NaMainWindow", "1", 0, QApplication::UnicodeUTF8));
        greenToggleButton->setText(QApplication::translate("NaMainWindow", "2", 0, QApplication::UnicodeUTF8));
        blueToggleButton->setText(QApplication::translate("NaMainWindow", "3", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        resetColorsButton->setToolTip(QApplication::translate("NaMainWindow", "Restore default color intensities.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        resetColorsButton->setText(QApplication::translate("NaMainWindow", "Reset Colors", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("NaMainWindow", "Sort by:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        gallerySortBySizeButton->setToolTip(QApplication::translate("NaMainWindow", "Show fragments with largest volume first", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        gallerySortBySizeButton->setText(QApplication::translate("NaMainWindow", "Size", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        gallerySortByIndexButton->setToolTip(QApplication::translate("NaMainWindow", "Arrange fragments by numeric index", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        gallerySortByIndexButton->setText(QApplication::translate("NaMainWindow", "Index", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        gallerySortByColorButton->setToolTip(QApplication::translate("NaMainWindow", "Arrange fragments by similar hue (first and last may be simiar too)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        gallerySortByColorButton->setText(QApplication::translate("NaMainWindow", "Color", 0, QApplication::UnicodeUTF8));
        gallerySortByNameButton->setText(QApplication::translate("NaMainWindow", "Name", 0, QApplication::UnicodeUTF8));
        menuFile->setTitle(QApplication::translate("NaMainWindow", "File", 0, QApplication::UnicodeUTF8));
        menuExport->setTitle(QApplication::translate("NaMainWindow", "Export", 0, QApplication::UnicodeUTF8));
        menuOpen_Recent->setTitle(QApplication::translate("NaMainWindow", "Open Recent", 0, QApplication::UnicodeUTF8));
        ...
        menuStereo_3D->setTitle(QApplication::translate("NaMainWindow", "Stereo 3D", 0, QApplication::UnicodeUTF8));
        menuAnimate->setTitle(QApplication::translate("NaMainWindow", "Animate", 0, QApplication::UnicodeUTF8));
        menuSet_canvas_size->setTitle(QApplication::translate("NaMainWindow", "Set canvas size", 0, QApplication::UnicodeUTF8));
        menuWork_Mode->setTitle(QApplication::translate("NaMainWindow", "Work-Mode", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
