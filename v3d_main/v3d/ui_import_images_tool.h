...
public:
    ...
    {
        import_images_tool->setWindowTitle(QApplication::translate("import_images_tool", "Image Sequence", 0, QApplication::UnicodeUTF8));
        startimgButton->setText(QApplication::translate("import_images_tool", "Start Image", 0, QApplication::UnicodeUTF8));
        numimgButton->setText(QApplication::translate("import_images_tool", "# files in the same folder", 0, QApplication::UnicodeUTF8));
        incButton->setText(QApplication::translate("import_images_tool", "Increment", 0, QApplication::UnicodeUTF8));
        filterButton->setText(QApplication::translate("import_images_tool", "File Name Contains", 0, QApplication::UnicodeUTF8));
        startimgButton_2->setText(QApplication::translate("import_images_tool", "End Image", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("import_images_tool", "info: the Names of the filtered images \n"
"are sorted numerically.", 0, QApplication::UnicodeUTF8));
        cancelButton->setText(QApplication::translate("import_images_tool", "Cancel", 0, QApplication::UnicodeUTF8));
        okButton->setText(QApplication::translate("import_images_tool", "OK", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
