...
int ShadeWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: colorsChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QPolygonF(*)>(_a[2]))); break;
        case 1: changeColors((*reinterpret_cast< const QPolygonF(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
...
int GradientEditor::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: pointsUpdated((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QPolygonF(*)>(_a[2]))); break;
        case 2: { QGradientStops _r = updateAlphaStops();
