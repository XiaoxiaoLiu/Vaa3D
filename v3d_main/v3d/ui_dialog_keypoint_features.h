...
public:
    ...
    {
        KeypointFeaturesDialog->setWindowTitle(QApplication::translate("KeypointFeaturesDialog", "Keypoint Features Vector", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("KeypointFeaturesDialog", "Keypoint No./label", 0, QApplication::UnicodeUTF8));
        order->setInputMask(QString());
        order->setText(QString());
        label_2->setText(QApplication::translate("KeypointFeaturesDialog", "Name", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("KeypointFeaturesDialog", "Comments", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("KeypointFeaturesDialog", "Keypoint Features", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("KeypointFeaturesDialog", "Geometry: center & others", 0, QApplication::UnicodeUTF8));
        label_x->setText(QApplication::translate("KeypointFeaturesDialog", "X", 0, QApplication::UnicodeUTF8));
        label_y->setText(QApplication::translate("KeypointFeaturesDialog", "Y", 0, QApplication::UnicodeUTF8));
        label_z->setText(QApplication::translate("KeypointFeaturesDialog", "Z (page)", 0, QApplication::UnicodeUTF8));
        label_channel->setText(QApplication::translate("KeypointFeaturesDialog", "Statistics of Channel", 0, QApplication::UnicodeUTF8));
        label_r->setText(QApplication::translate("KeypointFeaturesDialog", "radius", 0, QApplication::UnicodeUTF8));
        label_normalized->setText(QApplication::translate("KeypointFeaturesDialog", "Normalized", 0, QApplication::UnicodeUTF8));
        label_th->setText(QApplication::translate("KeypointFeaturesDialog", "threshold", 0, QApplication::UnicodeUTF8));
        orilabel->setText(QApplication::translate("KeypointFeaturesDialog", "PCA features of ori", 0, QApplication::UnicodeUTF8));
        label_lambda1_ori->setText(QApplication::translate("KeypointFeaturesDialog", "Lambda 1", 0, QApplication::UnicodeUTF8));
        label_lambda2_ori->setText(QApplication::translate("KeypointFeaturesDialog", "Lambda 2", 0, QApplication::UnicodeUTF8));
        label_lambda3_ori->setText(QApplication::translate("KeypointFeaturesDialog", "Lambda 3", 0, QApplication::UnicodeUTF8));
        checkBox_ori_scale1->setText(QApplication::translate("KeypointFeaturesDialog", "    scale 1", 0, QApplication::UnicodeUTF8));
        checkBox_ori_scale2->setText(QApplication::translate("KeypointFeaturesDialog", "    scale 2", 0, QApplication::UnicodeUTF8));
        checkBox_ori_scale3->setText(QApplication::translate("KeypointFeaturesDialog", "    scale 3", 0, QApplication::UnicodeUTF8));
        checkBox_ori_scale4->setText(QApplication::translate("KeypointFeaturesDialog", "    scale 4", 0, QApplication::UnicodeUTF8));
        difflabel->setText(QApplication::translate("KeypointFeaturesDialog", "PCA features of diff", 0, QApplication::UnicodeUTF8));
        label_lambda1_diff->setText(QApplication::translate("KeypointFeaturesDialog", "Lambda 1", 0, QApplication::UnicodeUTF8));
        label_lambda2_diff->setText(QApplication::translate("KeypointFeaturesDialog", "Lambda 2", 0, QApplication::UnicodeUTF8));
        label_lambda3_diff->setText(QApplication::translate("KeypointFeaturesDialog", "Lambda 3", 0, QApplication::UnicodeUTF8));
        checkBox_diff_scale1->setText(QApplication::translate("KeypointFeaturesDialog", "    scale 1", 0, QApplication::UnicodeUTF8));
        checkBox_diff_scale2->setText(QApplication::translate("KeypointFeaturesDialog", "    scale 2", 0, QApplication::UnicodeUTF8));
        checkBox_diff_scale3->setText(QApplication::translate("KeypointFeaturesDialog", "    scale 3", 0, QApplication::UnicodeUTF8));
        checkBox_diff_scale4->setText(QApplication::translate("KeypointFeaturesDialog", "    scale 4", 0, QApplication::UnicodeUTF8));
        GenSimMap->setText(QApplication::translate("KeypointFeaturesDialog", "Generating Similarity Map", 0, QApplication::UnicodeUTF8));
        cancelButton->setText(QApplication::translate("KeypointFeaturesDialog", "Cancel", 0, QApplication::UnicodeUTF8));
        okButton->setText(QApplication::translate("KeypointFeaturesDialog", "OK", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
