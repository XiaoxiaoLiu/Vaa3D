...
public:
    ...
    void retranslateUi(QWidget *GammaWidget)
    {
        ...
        gamma_label->setToolTip(QApplication::translate("GammaWidget", "Gamma (\316\223) brightness", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        gamma_label->setText(QApplication::translate("GammaWidget", "\316\223 ", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        gamma_slider->setToolTip(QApplication::translate("GammaWidget", "Drag to adjust gamma brightness", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        gamma_lineEdit->setToolTip(QApplication::translate("GammaWidget", "Gamma brightness: Larger values are darker.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        gamma_lineEdit->setText(QApplication::translate("GammaWidget", "1.00", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
